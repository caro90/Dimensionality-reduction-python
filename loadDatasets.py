...
def load_datasets(dataset_name):
    ...
    distances = scipy.io.loadmat('/home/arch/Matlab/Dimensionality Reduction/mat_files/Version 0.4/d0_distances_sin_method/cost 1 default/lambda 10000/{}_d0_distances.mat'.format(dataset_name))

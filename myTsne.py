...
tsne_classic = TSNE(n_components=2, learning_rate='auto', init='random').fit_transform(datasets_dict["data"])

# d0-TSNE:
tsne_d0 = TSNE(n_components=2, learning_rate='auto', init='random', metric='precomputed').fit_transform(datasets_dict["d0_distances"])
